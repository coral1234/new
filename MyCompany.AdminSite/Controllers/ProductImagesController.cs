...
namespace MyCompany.AdminSite.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PIDescription,ImgURL,Active,ProductId,CreateDateTime,UpdateDateTime")] ProductImage productImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PIDescription,ImgURL,Active,ProductId,CreateDateTime")] ProductImage productImage)
        {
            productImage.UpdateDateTime = DateTime.Now;
            if (ModelState.IsValid)
            {
